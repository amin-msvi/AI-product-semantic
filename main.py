...
def main():
    ...
    try:
        ...
        logger.info(f"Built knowledge graph with {len(results['knowledge_graph']['products'])} nodes")
        ...
        if results['query_results']:
            ...
            sample_results = results['query_results'][sample_query][:2]  # First 2 results
